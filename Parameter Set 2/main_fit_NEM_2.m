...
if Fit_ktr_murine_ctrl
    ...
    title('Fitting control murine data: ktr vs pCa', 'FontSize',20)
...
if Fit_ktr_murine_NEM
    ...
    title('Fitting NEM-S1 treated murine data: ktr vs pCa', 'FontSize',20)
    ax.TitleHorizontalAlignment = 'left';
    str(1) = {'Fitted parameter set:'};
...
if Fit_rel_SSF_murine_ctrl
    ...
    title('Fitting control murine data: P/P0 vs pCa', 'FontSize',20)
    ax.TitleHorizontalAlignment = 'left';
    str(1) = {'Fitted parameter set:'};
...
if Fit_rel_SSF_murine_NEM
    ...
    title('Fitting NEM-S1 treated murine data: P/P0 vs pCa', 'FontSize',20)
    ax.TitleHorizontalAlignment = 'left';
    str(1) = {'Fitted parameter set:'};
