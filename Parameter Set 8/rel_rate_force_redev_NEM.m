function rel_ktr = rel_rate_force_redev_NEM(para_fit,pCa)
    ...
    for i = 1:n
        ...
        p_resid = [ref_para_resid,Ca_Ca50(i),neighbor_interaction_para,NEM];
        func = @filament_function_NEM_S1;
        [~,y] = ode23s(@(r,y) func(r,y,p),tspan,initial_value);
        ...
        [t,~] = ode23s(@(t,x) func(t,x,p),tspan1,Yzero,opt);
        ktr(i) = - log(1/2)/t(end);
    end
